...
Note:** Make sure you are connected to IBIT network RPC. To learn how to add Infibit network RPC you can follow the tutorial [**here**](https://docs.infibitscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
**Step 2:** Click on “Bridge”. If you have “WETH \(Deprecated\)” when you click on the dropdown menu, then please follow the [**tutorial here**](https://docs.infibitscan.com/fuseswap/migration-tutorial) to learn how to migrate to the upgraded contract of WETH. Select “WETH” from the dropdown menu and enter the amount of WETH you want to transfer from Infibit to BSC. Click on “Approve WETH” and approve the transaction on Metamask. Once you approve and the transaction is confirmed on-chain the interface will look as shown below.

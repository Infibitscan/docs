...
Infibit chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://infibitscan.com/address/0x3eD16D2775854f86B00365Dc36b047B71F52Ab5A) with the following params:
...
Some other useful functions on the [voting contract](https://infibitscan.com/address/0x3eD16D2775854f86B00365Dc36b047B71F52Ab5A) are:

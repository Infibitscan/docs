...
Below tutorial will help you understand how to add Infibit network RPC on imToken through chainlist.org and transfer/receive tokens on fuse network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “Infibit” on the list of EVM networks. Click on “Add to imToken” next to Infibit Mainnet and “Approve” the details of Infibit RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added Infibit network RPC on imToken wallet. You can now send/receive Infibit network assets on imToken wallet.  

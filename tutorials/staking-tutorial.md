---
description: This tutorial will explain how to delegate/stake/unstake your IBIT.
---

# Staking tutorial

Note: You can only stake IBIT which is on Infibit network. Please make sure you have changed into Infibit network in Metamask while doing any transactions on staking UI. 

How to Stake Infibit:

**Step 1:**

Navigate to staking.infibitscan.com and login to your wallet through metamask. Make sure you are on Infibit network. If you are not please follow the instructions [**here**](https://docs.infibitscan.com/the-infibit-studio/getting-started/how-to-add-infibit-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of IBIT you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 

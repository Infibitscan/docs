...
Make sure that the network is IBIT network. If you have not added Infibit network please follow the instructions [here](https://docs.infibitscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).

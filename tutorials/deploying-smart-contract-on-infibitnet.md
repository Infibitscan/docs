...
Infibit is an EVM compatible network, every tool for Ethereum can be used for the Infibit network too.
...
Since we interact with remix using Metamask, you need to change the network to Infibit network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.infibitscan.com/the-infibit-studio/getting-started/how-to-add-infibit-to-your-metamask) to do that.

You need to have a small balance of IBIT on the Fusenet wallet you are using which will be used as Gas for the transactions.

...
Since we interact with remix using Metamask, you need to change the network to Infibit network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.infibitscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) to do that.
